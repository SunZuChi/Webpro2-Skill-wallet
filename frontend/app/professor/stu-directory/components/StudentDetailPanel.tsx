            ...
            {selectedStudent ? (
                <div className="max-w-5xl w-full space-y-10 md:space-y-12 animate-in fade-in slide-in-from-right-4 duration-500 pt-2 lg:pt-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6 text-left">
                        <div className="flex items-center gap-5 md:gap-8">
                            <div className="relative shrink-0">
                                <img 
                                    ...
                                    className={`w-20 h-20 md:w-32 md:h-32 rounded-xl md:rounded-2xl border-2 shadow-2xl object-cover shrink-0 transition-all ${
                                        isLegendary 
                        ...
                        <div className={`border rounded-3xl p-5 md:p-6 flex flex-col items-center justify-center min-w-30 md:min-w-35 shadow-2xl shrink-0 self-start sm:self-auto transition-all ${
                            isLegendary 
