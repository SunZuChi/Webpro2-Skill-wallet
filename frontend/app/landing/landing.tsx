    ...
    <div className="min-h-screen bg-white text-slate-800 antialiased overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
         <div 
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <button onClick={onLoginClick} className="cursor-pointer bg-black text-white px-8 py-2.5 rounded-full font-bold hover:bg-slate-800 transition-all shadow-md active:scale-95">
              Login
            </button>
          </nav>
      ...
      <section className="relative pt-20 pb-12 sm:pt-28 md:pt-32 lg:pt-48 md:pb-16 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-14 lg:gap-16 items-center">
          <div className="max-w-[580px] text-center lg:text-left animate-slide-in-left">
            ...
            <p className="text-base sm:text-lg md:text-lg text-slate-600 mb-6 sm:mb-8 md:mb-10 leading-relaxed max-w-[500px] mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              <button onClick={onSignUpClick} className="cursor-pointer bg-[#ff4f40] text-white font-bold px-6 sm:px-10 py-3 sm:py-4 rounded-full hover:bg-[#e53e30] transition-all shadow-xl shadow-rose-200 flex items-center justify-center gap-2 group text-sm sm:text-base">
      ...
      {/* 4. Your Verified Expertise (จากภาพ landing-page3.png) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 text-center">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            {[
              ...
              return (
              <div key={i} className={`bg-white rounded-xl sm:rounded-2xl md:rounded-[2rem] lg:rounded-[2.5rem] p-6 sm:p-7 md:p-8 border border-slate-200 hover:-translate-y-2 transition-all duration-500 text-left flex flex-col group animate-bounce-in ${bounceClasses[i]} scroll-zoom`} data-scroll>
                <div className={`w-14 sm:w-16 md:w-16 h-14 sm:h-16 md:h-16 rounded-lg sm:rounded-xl md:rounded-[1.3rem] lg:rounded-[1.5rem] ${b.bgColor} ${b.textColor} flex items-center justify-center mb-6 md:mb-8 group-hover:rotate-6 transition-transform shrink-0`}>
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-white" id="verification">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-14 lg:gap-20 items-center">
          ...
          <div className="relative order-1 lg:order-2 animate-slide-in-right hidden sm:block">
             ...
             {/* Floating Status UI */}
             <div className="absolute top-6 sm:top-10 md:top-12 -left-24 sm:-left-30 md:-left-32 lg:-left-35 bg-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-2xl md:rounded-[2rem] shadow-2xl border border-emerald-100 flex items-center gap-3 sm:gap-4 md:gap-5 animate-float z-20 max-w-[260px] sm:max-w-none">
             ...
             <div className="absolute bottom-2 sm:bottom-8 md:bottom-10 -right-16 sm:-right-12 md:-right-10 bg-white p-3 sm:p-5 md:p-6 rounded-lg sm:rounded-2xl md:rounded-[2rem] shadow-2xl border border-blue-100 max-w-[250px] sm:max-w-[300px] md:max-w-[320px] animate-float z-20" style={{ animationDelay: '1s' }}>
