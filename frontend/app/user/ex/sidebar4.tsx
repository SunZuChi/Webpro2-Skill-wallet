    ...
    <div className="flex h-screen overflow-hidden bg-[#050505] text-white font-lineseed selection:bg-[#ff4f40]/30 selection:text-white">
          ...
          >
            ...
            <nav className="flex flex-col w-full px-4 gap-2">
              ...
              {/* Export Resume */}
              <Link href="/user/export"><div className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-4'} px-4 py-3.5 rounded-xl bg-white/5 text-white border border-white/10 text-sm font-bold relative overflow-hidden group cursor-pointer transition-all`}>
                {!isCollapsed && (
                ...
                <FileUp size={20} className="text-[#ff4f40] shrink-0" /> 
