...
export const Achivement = ({ requests, loading, onViewAll }: { requests: BadgeRequest[]; loading: boolean; onViewAll?: () => void }) => {return (
                ...
                <div className="xl:col-span-5 bg-[#0f0f11] border border-white/5 rounded-[2.5rem] p-10 flex flex-col min-h-[480px] shadow-2xl">
                  ...
                  <div className="space-y-4 flex-1">
                    {loading ? (
                      ...
                      requests.map((req) => {
                        const catColor = categoryColorClass[req.category] || 'text-slate-400 bg-slate-400/5 border-slate-400/10';
                        return (
