...
import { ShieldCheck, ChevronRight, Quote } from 'lucide-react';

export const FeedbackPage = () => {
  return (
    <div className="bg-[#0f0f11] border border-white/5 rounded-4xl md:rounded-[2.5rem] p-6 md:p-10 flex flex-col space-y-6 md:space-y-8 shadow-2xl shadow-rose-500/5">
      <div className="flex items-center justify-between">
        <div className="text-left">
          <h3 className="text-base md:text-xl font-bold">Professor Feedback & Activity</h3>
          <p className="text-xs text-slate-500 mt-1">Track your evaluation history and comments from faculty</p>
        </div>
        <button className="text-xs font-bold text-[#ff4f40] hover:underline uppercase tracking-widest flex items-center gap-1 group cursor-pointer transition-all shrink-0 ml-4">
      ...
      <div className="space-y-6 md:space-y-8">
        <div className="flex flex-col gap-4 items-start">
          ...
          <div className="text-left">
            <h4 className="text-base md:text-xl font-bold">Credential Issued: Basic App Wireframe</h4>
          ...
          <div className="bg-[#050505] rounded-3xl md:rounded-4xl p-5 md:p-8 border border-white/5 relative group w-full text-left overflow-hidden">
            <div className="absolute top-4 right-6 md:top-6 md:right-8 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity">
              <Quote size={60} />
            </div>
            <div className="flex gap-4 md:gap-6 items-start relative z-10">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden border-2 border-white/10 shrink-0 shadow-2xl">
                <img
