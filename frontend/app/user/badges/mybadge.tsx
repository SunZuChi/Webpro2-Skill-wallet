...
export default function MyBadgesPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#050505] text-white font-lineseed selection:bg-[#ff4f40]/30 selection:text-white">
      ...
      {/* MAIN CONTENT AREA */}
      {/* pt-14 คือ offset ของ mobile top bar จาก Sidebar2 */}
      <main className="flex-1 overflow-y-auto flex flex-col transition-all duration-300 relative pt-14 md:pt-0">
        <div className="absolute top-0 right-0 w-150 h-150 bg-[#ff4f40]/5 rounded-full blur-[120px] pointer-events-none -z-10" />

        {/* Header — ซ่อน hamburger เพราะ Sidebar2 จัดการแล้ว */}
        <header className="h-14 md:h-17.5 lg:h-22.5 border-b border-white/5 sticky top-0 bg-[#050505]/80 backdrop-blur-xl z-40 flex items-center shrink-0">
          <div className={containerClass}>
            <div className="flex items-center justify-between">
              <h1 className="text-lg sm:text-xl md:text-2xl font-bold tracking-tight">My Badges</h1>
            </div>
          </div>
        </header>
        ...
        <footer className="mt-auto px-4 py-8 sm:p-10 text-center opacity-30">
